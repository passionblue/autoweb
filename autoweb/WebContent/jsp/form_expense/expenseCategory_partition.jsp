...
<%
    ...
    String _expense_categoryValue= "";
    String _time_createdValue= "";
    String _time_updatedValue= "";

%>

<div id="partitionFormFrame_expense_category_<%= catchString %>" class="partitionFormFrame"><!-- This is loaded from /ExpenseCategory_artition.jsp -->

	<script type="text/javascript">
		function sendForm_expense_category_<%= catchString %>() { 
	...
	<a id="ajaxSubmit<%= catchString %>" href="javascript:sendForm_expense_category_<%= catchString %>;">Submit</a>
	<br>
	<br>
