...
<% 
	...
	List list = SitePostDS.getInstance().getBySiteId(site.getId());// .getSitePostBySiteId(site.getId(), displaySitePostType);
...
<% 
	...
	list = SitePostDS.getInstance().getBySiteId(site.getId());// .getSitePostBySiteId(site.getId(), displaySitePostType);
