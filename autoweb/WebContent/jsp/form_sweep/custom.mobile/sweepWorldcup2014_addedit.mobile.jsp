...
<form name="sweepWorldcup2014Form_Form" method="POST" action="/sweepWorldcup2014Action.html" id="sweepWorldcup2014Form_Form">
    ...
    <div id="sweepWorldcup2014Form_game1_text" class="formFieldText" >       
        <input id="game1" class="field" type="text" size="70" name="game1" value="<%=WebUtil.display(_game_1Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_game2_text" class="formFieldText" >       
        <input id="game2" class="field" type="text" size="70" name="game2" value="<%=WebUtil.display(_game_2Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_game3_text" class="formFieldText" >       
        <input id="game3" class="field" type="text" size="70" name="game3" value="<%=WebUtil.display(_game_3Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
...
<%} %>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal1_text" class="formFieldText" >       
        <input id="quarterFinal1" class="field" type="text" size="70" name="quarterFinal1" value="<%=WebUtil.display(_quarter_final_1Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal2_text" class="formFieldText" >       
        <input id="quarterFinal2" class="field" type="text" size="70" name="quarterFinal2" value="<%=WebUtil.display(_quarter_final_2Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal3_text" class="formFieldText" >       
        <input id="quarterFinal3" class="field" type="text" size="70" name="quarterFinal3" value="<%=WebUtil.display(_quarter_final_3Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal4_text" class="formFieldText" >       
        <input id="quarterFinal4" class="field" type="text" size="70" name="quarterFinal4" value="<%=WebUtil.display(_quarter_final_4Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal5_text" class="formFieldText" >       
        <input id="quarterFinal5" class="field" type="text" size="70" name="quarterFinal5" value="<%=WebUtil.display(_quarter_final_5Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal6_text" class="formFieldText" >       
        <input id="quarterFinal6" class="field" type="text" size="70" name="quarterFinal6" value="<%=WebUtil.display(_quarter_final_6Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal7_text" class="formFieldText" >       
        <input id="quarterFinal7" class="field" type="text" size="70" name="quarterFinal7" value="<%=WebUtil.display(_quarter_final_7Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_quarterFinal8_text" class="formFieldText" >       
        <input id="quarterFinal8" class="field" type="text" size="70" name="quarterFinal8" value="<%=WebUtil.display(_quarter_final_8Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_semiFinal1_text" class="formFieldText" >       
        <input id="semiFinal1" class="field" type="text" size="70" name="semiFinal1" value="<%=WebUtil.display(_semi_final_1Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_semiFinal2_text" class="formFieldText" >       
        <input id="semiFinal2" class="field" type="text" size="70" name="semiFinal2" value="<%=WebUtil.display(_semi_final_2Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_semiFinal3_text" class="formFieldText" >       
        <input id="semiFinal3" class="field" type="text" size="70" name="semiFinal3" value="<%=WebUtil.display(_semi_final_3Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_semiFinal4_text" class="formFieldText" >       
        <input id="semiFinal4" class="field" type="text" size="70" name="semiFinal4" value="<%=WebUtil.display(_semi_final_4Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_final1_text" class="formFieldText" >       
        <input id="final1" class="field" type="text" size="70" name="final1" value="<%=WebUtil.display(_final_1Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_final2_text" class="formFieldText" >       
        <input id="final2" class="field" type="text" size="70" name="final2" value="<%=WebUtil.display(_final_2Value)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="sweepWorldcup2014Form_champion_text" class="formFieldText" >       
        <input id="champion" class="field" type="text" size="70" name="champion" value="<%=WebUtil.display(_championValue)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
