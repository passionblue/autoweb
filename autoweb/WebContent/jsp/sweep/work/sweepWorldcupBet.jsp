...
%>
	<h4 style="margin: 50px 0px 50px 0px;"> You have already entered the maximum allowed number of Sweepstakes. You can edit your Sweepstakes in <a href="/v_select_team.html"> here</a></h4>
<% 	
		return;
	}%>
...
<div id="pageType" style="display:none">NEWBET</div>
...
<!-- ===================================================================================================================== -->
    ...
    <div style="margin-left: 150px;float:left;font:normal normal normal 11px verdanda" >Win or Lose </div>
    <div style="margin-left: 60px;float:left;font:normal normal normal 11px verdanda" >My Team </div>
    <div style="margin-left: 20px;float:left;font:normal normal normal 11px verdanda" >Opponent </div>
	<div class="clear"></div>
    ...
    <div id="sweepWorldcupForm_game1_dropdown" class="formFieldDropDown" >       
        <select id="requiredField" name="game1" style="width:130px">
    ...
    <div id="sweepWorldcupForm_game2_dropdown" class="formFieldDropDown" >       
        <select id="requiredField" name="game2" style="width:130px">
        <option value="" >- Please Select -</option>
    ...
    <div id="sweepWorldcupForm_game3_dropdown" class="formFieldDropDown" >       
        <select id="requiredField" name="game3" style="width:130px">
        <option value="" >- Please Select -</option>
...
<br/>
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_1" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_1" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_1_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_2" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_2" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_2_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_3" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_3" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_3_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_4" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_4" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_4_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_5" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_5" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_5_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_6" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_6" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_6_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_7" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_7" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_7_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_quarterFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="quarterFinalTeam_8" class="requiredField" type="hidden" size="10" name="quarterFinalTeam_8" value="<%=WebUtil.display(_quarter_final_teamsValue)%>"/>
		<div id="quarterFinalTeam_8_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_semiFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="semiFinalTeam_1" class="requiredField" type="hidden" size="10" name="semiFinalTeam_1" value="<%=WebUtil.display(_semi_final_teamsValue)%>"/>
		<div id="semiFinalTeam_1_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_semiFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="semiFinalTeam_2" class="requiredField" type="hidden" size="10" name="semiFinalTeam_2" value="<%=WebUtil.display(_semi_final_teamsValue)%>"/>
		<div id="semiFinalTeam_2_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_semiFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="semiFinalTeam_3" class="requiredField" type="hidden" size="10" name="semiFinalTeam_3" value="<%=WebUtil.display(_semi_final_teamsValue)%>"/>
		<div id="semiFinalTeam_3_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_semiFinalTeams_text" class="formFieldText" > <span></span>      
        <input id="semiFinalTeam_4" class="requiredField" type="hidden" size="10" name="semiFinalTeam_4" value="<%=WebUtil.display(_semi_final_teamsValue)%>"/>
		<div id="semiFinalTeam_4_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_finalTeams_text" class="formFieldText" > <span></span>      
        <input id="finalTeam_1" class="requiredField" type="hidden" size="10" name="finalTeam_1" value="<%=WebUtil.display(_final_teamsValue)%>"/>
		<div id="finalTeam_1_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_finalTeams_text" class="formFieldText" > <span></span>      
        <input id="finalTeam_2" class="requiredField" type="hidden" size="10" name="finalTeam_2" value="<%=WebUtil.display(_final_teamsValue)%>"/>
		<div id="finalTeam_2_div" class="selectedField">Select Team</div>
    </div>      
    ...
    <div id="sweepWorldcupForm_champion_text" class="formFieldText" > <span></span>      
        <input id="championTeam_1" class="requiredField" type="hidden" size="10" name="championTeam_1" value="<%=WebUtil.display(_championValue)%>"/>
		<div id="championTeam_1_div" class="selectedField">Select Team</div>
    </div>      
...
<!-- ===================================================================================================================== -->
	...
	<div>
        <div id="sweepWorldcupForm_submit" class="formSubmit" style="float:left;margin: 0 0 0 0;">       
            <a id="betSubmit" href="javascript:document.sweepWorldcupForm.submit();">Submit</a>
        </div>      
...
<INPUT TYPE="HIDDEN" NAME="returnPage" value="select_team">
