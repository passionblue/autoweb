...
<%-- ####################################### BODY  #################################################################### --%>
<body topmargin="0" bgcolor="#ffffff" onload="window.print()"> 
<% 
...
<div id="out-frame-printable" style="width:100%;margin: 0px;background-color:red"> 
<!-- div id="leftSpace" style="width:50px;background-color:transparent ;float:left;height:100%"> &nbsp;</div-->
<div id="wrapper-printable" style="margin: 0 0 0 0;float:left;width:100%" class="wrapper">
...
<%
	if ( false && sessionContext != null && sessionContext.isSuperAdminLogin()){
%>
