...
<link rel="stylesheet" type="text/css" href="/customstyles/<%=siteCssIndex %>/main.css"/>
<link rel="stylesheet" type="text/css"  href="/customstyles/<%=siteCssIndex %>/main_forms.css"/>
<link rel="stylesheet" type="text/css" href="/customstyles/<%=siteCssIndex %>/main_table.css"/>
<link rel="stylesheet" type="text/css" href="/customstyles/<%=siteCssIndex %>/layout.css"/>
<link rel="stylesheet" type="text/css" href="/customstyles/<%=siteCssIndex %>/panel.css"/>
<link rel="stylesheet" type="text/css" href="/customstyles/<%=siteCssIndex %>/panel_content.css"/>
<link rel="stylesheet" type="text/css"  href="/customstyles/<%=siteCssIndex %>/main_default_html.css"/>
...
<%-- ############## Input Masked 1.3.1 http://digitalbush.com/projects/masked-input-plugin/ ################################################################################# --%>
<script type="text/javascript" src="/js/maskedinput/jquery.maskedinput.min.js"></script> 



<%-- ############## facebox http://defunkt.github.com/facebox/ ############################################## --%>
<link href="/js/facebox-1.2/facebox.css" media="screen" rel="stylesheet" type="text/css"/>
<script src="/js/facebox-1.2/facebox.js" type="text/javascript"></script> 
...
<% if ( sessionContext.isSuperAdmin() || true) { %>
