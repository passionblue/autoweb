...
<% 
	if (isLogin) {
%>
	[<a href="t_panel_add.html?prv_columnNum=6&prv_align=1&prv_topSpace=0" ><b>6+</b></a>]
<% 
	}
%>
...
<TABLE border="0" width="<%=width %>" align="center" cellpadding="0" cellspacing="0">
	<TR><TD><jsp:include page="/jsp/sidemenus/dyn_menu_top.jsp" />
	</TD></TR>
</TABLE>
<% } %>
...
<% 
	if (isLogin) {
%>
		[<a href="t_panel_add.html?prv_columnNum=5&prv_align=1&prv_topSpace=0" ><b>5+</b></a>]
<% 
	}
%>
</div><!-- header-wrapper -->
...
<% 
	if (isLogin) {
%>
	[<a href="t_panel_add.html?prv_columnNum=9&prv_align=1&prv_topSpace=0" ><b>9+</b></a>]
<% 
	}
%>
