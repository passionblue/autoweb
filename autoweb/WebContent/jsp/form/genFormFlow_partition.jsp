...
<div id="partitionFormFrame_gen_form_flow_<%= catchString %>" class="partitionFormFrame"><!-- This is loaded from /GenFormFlow_artition.jsp -->

	<script type="text/javascript">
		function sendForm_gen_form_flow_<%= catchString %>() { 
	...
	<a id="ajaxSubmit<%= catchString %>" href="javascript:sendForm_gen_form_flow_<%= catchString %>;">Submit</a>
	<br>
	<br>
