...
<% 
	...
	if ( !isEdit) {
	    ...
	    if ( _TestCore == null) _TestCore = new TestCore();
    ...
    String pagestamp = "test_core_" + System.nanoTime();
%> 
...
<% if (!WebUtil.isNull(backPage)) {%>
    <div id="testCoreForm_submit_back" class="formButton" >       
...
<script type="text/javascript">
	$(document).ready(function(){
		setInterval(function(){
			$ .ajax({
			   type: "GET",
		   		url: "/testCoreAction.html?ajxr=hb",
