...
<script type="text/javascript" src="/testWrapAction.html?ajaxRequest=true&ajaxOut=getscriptform"></script>
...
<TABLE border="1" width="100%" bgcolor="transparent" align="center" cellspacing="0" style="border-width: 1px; border-style: solid">
    ...
    <TR>
        <TD>
        	AJAX | 
			<a href="/testWrapAction.html?ajaxRequest=true&ajaxOut=getmodalform&formfieldlist=&forcehiddenlist=" rel="facebox"> open form</a> |
			<a href="/testWrapAction.html?ajaxRequest=true&ajaxOut=getmodalform" rel="facebox"> open form</a> |
			<a href="/testWrapAction.html?ajaxRequest=true&ajaxOut=getlisthtml" rel="facebox"> getlisthtml</a> |
			<a href="/testWrapAction.html?ajaxRequest=true&ajaxOut=getlistjson" rel="facebox"> getlistjson</a> |
			<a href="/testWrapAction.html?ajaxRequest=true&ajaxOut=getjson&ajaxOutArg=first" rel="facebox">getjson first</a> |
			<a href="/testWrapAction.html?ajaxRequest=true&ajaxOut=getjson&ajaxOutArg=last" rel="facebox">getjson last</a> |
			<a href="/testWrapAction.html?ajaxRequest=true&ajaxOut=getlistdata" rel="facebox">getlistdata</a> |
		</TD>        
...
<TR bgcolor="#ffffff" valign="top">
	...
	<form name="testWrapFormEditField_WrapData_<%=_TestWrap.getId()%>" method="get" action="/testWrapAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="wrapData">	Update </a>
