...
<a href="/v_test_core_home.html"> TestCore Home </a>
<%
	
	List list = null;
	list = TestCoreDS.getInstance().getBySiteId(site.getId());
...
%>
	...
	<div id="testCoreFrame<%=_TestCore.getId() %>" >

		<div id="data" >
			data:<%= _TestCore.getData() %>
		</div>
		<div id="timeCreated" >
			timeCreated:<%= _TestCore.getTimeCreated() %>
		</div>
		<div>
		<a id="testCoreDeleteButton" href="javascript:deleteThis('/testCoreAction.html',<%= _TestCore.getId()%>,'testCoreFrame<%=_TestCore.getId()%>' );" > 
...
<form name="testCoreFormAdd" method="POST" action="/testCoreAction.html" id="testCoreFormAdd">
...
function responseCallback(data){
	document.getElementById("resultDisplayTestCore").innerHTML = data;
}

function sendRequest(){
	xmlhttpPostXX('testCoreFormAddDis','/testCoreAction.html', 'resultDisplayTestCore', '${ajax_response_fields}', responseCallback);
}
</script>
...
<span id="resultDisplayTestCore"></span>
<a href="javascript:backToXX('testCoreFormAddDis','resultDisplayTestCore')">show back</a><br>
<hr/>
