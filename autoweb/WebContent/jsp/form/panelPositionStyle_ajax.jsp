...
<% 
    ...
    String _colValue= WebUtil.display((String)reqParams.get("col"));
...
<a href="/v_panel_position_style_home.html"> PanelPositionStyle Home </a>
<%
	
	List list = null;
	list = PanelPositionStyleDS.getInstance().getBySiteId(site.getId());

%>

<div id="panelPositionStyleList"> 
<%
	for(Iterator iter = list.iterator();iter.hasNext();){
		PanelPositionStyle _PanelPositionStyle = (PanelPositionStyle) iter.next();	
%>

	<div id="panelPositionStyleFrame<%=_PanelPositionStyle.getId() %>" >

		<div id="col" >
			col:<%= _PanelPositionStyle.getCol() %>
		</div>
		<div id="styleId" >
			styleId:<%= _PanelPositionStyle.getStyleId() %>
		</div>
		<div id="timeCreated" >
			timeCreated:<%= _PanelPositionStyle.getTimeCreated() %>
		</div>
		<div>
		<a id="panelPositionStyleDeleteButton" href="javascript:deleteThis('/panelPositionStyleAction.html',<%= _PanelPositionStyle.getId()%>,'panelPositionStyleFrame<%=_PanelPositionStyle.getId()%>' );" > 
...
<form name="panelPositionStyleFormAdd" method="POST" action="/panelPositionStyleAction.html" id="panelPositionStyleFormAdd">
    ...
    <div id="panelPositionStyleForm_col_text" class="formFieldText" >       
        <input class="field" id="_ffd_col" type="text" size="70" name="col" value="<%=WebUtil.display(_colValue)%>"/> <span></span>
    </div>      
    ...
    <div id="panelPositionStyleForm_styleId_text" class="formFieldText" >       
        ...
        <div id="panelPositionStyleFormEdit_submit" class="formSubmit" >       
            <a id="formSubmit_ajax" href="javascript:sendFormAjax2('/panelPositionStyleAction.html', 'panelPositionStyleFormAdd', 'formSubmit_ajax', 'panelPositionStyle');">Submit</a>
        </div> 
...
function responseCallback(data){
	document.getElementById("resultDisplayPanelPositionStyle").innerHTML = data;
}

function sendRequest(){
	xmlhttpPostXX('panelPositionStyleFormAddDis','/panelPositionStyleAction.html', 'resultDisplayPanelPositionStyle', '${ajax_response_fields}', responseCallback);
}
</script>



<form name="panelPositionStyleFormAddDis" method="POST" action="/panelPositionStyleAction.html" id="panelPositionStyleFormAddDis">
	<INPUT TYPE="HIDDEN" NAME="add" value="true">


		 <div class="ajaxFormLabel"> Col</div>
        <input class="field" id="col" type="text" size="70" name="col" value="<%=WebUtil.display(_colValue)%>"/> <span></span>
		<br/>
	...
	<a href="javascript:clearFormXX('panelPositionStyleFormAddDis')">Clear Form</a><br>
    <a href="/moveTo.html?dest=<%=cancelPage%>">Cancel</a><br>

	<!--INPUT TYPE="HIDDEN" id="_ffd_wpid" name="wpid" value=" _wpId " -->

</form>
<span id="resultDisplayPanelPositionStyle"></span>
<a href="javascript:backToXX('panelPositionStyleFormAddDis','resultDisplayPanelPositionStyle')">show back</a><br>
<hr/>
