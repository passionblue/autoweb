...
<a href="t_page_style_form.html?prv_returnPage=page_style_home"> Add New 2</a> <br>
...
<%	
	if (showListAllByAdmin) {
	long siteId = _PageStyle.getSiteId();
...
<% 	} %>
	...
	<td> <%= _PageStyle.getPageId()  %> </td>
	<td> <%= _PageStyle.getStyleId()  %> </td>
</TR>
