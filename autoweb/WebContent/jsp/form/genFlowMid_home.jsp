...
<script type="text/javascript" src="/genFlowMidAction.html?ajxr=getscriptform"></script>
...
<TABLE border="1" width="100%" bgcolor="transparent" align="center" cellspacing="0" style="border-width: 1px; border-style: solid">
    <TR>
        <TD>
            <a href="v_gen_flow_mid_form.html?prv_returnPage=gen_flow_mid_home"> Add New </a> |
            <a href="v_gen_flow_mid_list.html?"> List Page </a> |
            <a href="v_gen_flow_mid_ajax.html?"> Ajax Sampler </a> |
        </TD>
    </TR>
    <TR>
        <TD>
        	AJAX | 
			<a href="/genFlowMidAction.html?ajxr=getmodalform&formfieldlist=&forcehiddenlist=" rel="facebox"> open form (custom field list)</a> |
			<a href="/genFlowMidAction.html?ajxr=getmodalform" 			rel="facebox"> open form</a> |
			<a href="/genFlowMidAction.html?ajxr=getlisthtml"  			rel="facebox"> getlisthtml</a> |
			<a href="/genFlowMidAction.html?ajxr=getlistjson"  			rel="facebox"> getlistjson</a> |
			<a href="/genFlowMidAction.html?ajxr=getjson&ajaxOutArg=first" rel="facebox"> getjson first</a> |
			<a href="/genFlowMidAction.html?ajxr=getjson&ajaxOutArg=last" 	rel="facebox"> getjson last</a> |
			<a href="/genFlowMidAction.html?ajxr=getlistdata" 				rel="facebox"> getlistdata</a> |
		</TD>        
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	    <div id="genFlowMidForm_address_label" style="font-size: normal normal bold 10px verdana;" >Address </div>
    </td> 
    <td> 
	    <div id="genFlowMidForm_phone_label" style="font-size: normal normal bold 10px verdana;" >Phone </div>
    </td> 
	<td></td>
	<td></td>
</TR>
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> <%= _GenFlowMid.getId() %> </td>


    <td> 
	<form name="genFlowMidFormEditField_Address_<%=_GenFlowMid.getId()%>" method="get" action="/genFlowMidAction.html" >


		<div id="genFlowMidForm_address_field">
	    <div id="genFlowMidForm_address_text" class="formFieldText" >       
	        <input id="field" type="text" size="20" name="address" value="<%=WebUtil.display(_GenFlowMid.getAddress())%>"/> <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
			<div id="address_<%= _GenFlowMid.getId()%>"><%=_GenFlowMid.getAddress() %></div>
            <a id="formSubmit" href="javascript:document.genFlowMidFormEditField_Address_<%=_GenFlowMid.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_GenFlowMid.getId()%>', 'address', '<%=_GenFlowMid.getAddress()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="address">	Update </a>
			<a id="update_field_by_ajax_open_reply" href="#" rel="address">	Update </a>

	<INPUT TYPE="HIDDEN" NAME="editfield" value="true">
	<INPUT TYPE="HIDDEN" NAME="id" value="<%=_GenFlowMid.getId()%>">
	<INPUT TYPE="HIDDEN" NAME="returnPage" value="gen_flow_mid_home">
	</form>
    ...
    <td> 
	<form name="genFlowMidFormEditField_Phone_<%=_GenFlowMid.getId()%>" method="get" action="/genFlowMidAction.html" >


		<div id="genFlowMidForm_phone_field">
	    <div id="genFlowMidForm_phone_text" class="formFieldText" >       
	        <input id="field" type="text" size="20" name="phone" value="<%=WebUtil.display(_GenFlowMid.getPhone())%>"/> <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
			<div id="phone_<%= _GenFlowMid.getId()%>"><%=_GenFlowMid.getPhone() %></div>
            <a id="formSubmit" href="javascript:document.genFlowMidFormEditField_Phone_<%=_GenFlowMid.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_GenFlowMid.getId()%>', 'phone', '<%=_GenFlowMid.getPhone()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="phone">	Update </a>
			<a id="update_field_by_ajax_open_reply" href="#" rel="phone">	Update </a>
    ...
    <td>
    <form name="genFlowMidForm<%=_GenFlowMid.getId()%>2" method="get" action="/v_gen_flow_mid_form.html" >
        <a href="javascript:document.genFlowMidForm<%=_GenFlowMid.getId()%>2.submit();">Edit</a>           
        <INPUT TYPE="HIDDEN" NAME="id" value="<%= _GenFlowMid.getId() %>">
        <INPUT TYPE="HIDDEN" NAME="cmd" value="edit">
        <INPUT TYPE="HIDDEN" NAME="prv_returnPage" value="gen_flow_mid_home">
    </form>
    <a href="javascript:;" title="Edit" class="deleteLink" onclick="edit_gen_flow_mid_form('<%=_GenFlowMid.getId()%>');">Edit</a>
    </td>

    <td>
    <a href="/genFlowMidAction.html?del=true&id=<%=_GenFlowMid.getId()%>"> Delete </a><BR>
    <a href="javascript:;" title="Delete User" class="deleteLink" onclick="confirm_remove_gen_flow_mid('<%=_GenFlowMid.getId()%>');">DeleteWConfirm</a>
    </td>
</TR>
...
<script type="text/javascript">
	...
	function edit_gen_flow_mid_form(target){
		location.href='/v_gen_flow_mid_form.html?cmd=edit&prv_returnPage=gen_flow_mid_home&id=' + target;
	}

	function confirm_gen_flow_mid(target, txt){
		$ .prompt(txt,{ 
	...
	function confirm_remove_gen_flow_mid(target){
		$ .prompt('Are you sure you want to remove this?',{ 
			buttons:{Delete:true, Cancel:false},
			callback: function(v,m,f){
				if(v){
					location.href="/genFlowMidAction.html?del=true&id="+target;
				}
			}
		});
	}
			...
			callback: function(v,m,f){
				if (v){
					if (f.myname == "") {
						...
						location.href="/genFlowMidAction.html?editfield=true&returnPage=cleaner_pickup_home&id="+targetId+"&"+targetField +"=" +f.myname;
					}
				}
				return true;
			}
