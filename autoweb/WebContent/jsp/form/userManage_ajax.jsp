...
<a href="/v_user_manage_home.html"> UserManage Home </a>
<%
	
	List list = null;
	list = UserManageDS.getInstance().getBySiteId(site.getId());
...
%>
	...
	<div id="userManageFrame<%=_UserManage.getId() %>" >

		<div id="extString" >
			extString:<%= _UserManage.getExtString() %>
		</div>
		<div id="extInt" >
			extInt:<%= _UserManage.getExtInt() %>
		</div>
		<div>
		<a id="userManageDeleteButton" href="javascript:deleteThis('/userManageAction.html',<%= _UserManage.getId()%>,'userManageFrame<%=_UserManage.getId()%>' );" > 
...
<form name="userManageFormAdd" method="POST" action="/userManageAction.html" id="userManageFormAdd">
    ...
    <div id="userManageForm_extInt_text" class="formFieldText" >       
        ...
        <div id="userManageFormEdit_submit" class="formSubmit" >       
            <a id="formSubmit_ajax" href="javascript:sendFormAjax2('/userManageAction.html', 'userManageFormAdd', 'formSubmit_ajax', 'userManage');">Submit</a>
        </div> 
...
function responseCallback(data){
	document.getElementById("resultDisplayUserManage").innerHTML = data;
}

function sendRequest(){
	xmlhttpPostXX('userManageFormAddDis','/userManageAction.html', 'resultDisplayUserManage', '${ajax_response_fields}', responseCallback);
}
</script>



<form name="userManageFormAddDis" method="POST" action="/userManageAction.html" id="userManageFormAddDis">
	<INPUT TYPE="HIDDEN" NAME="add" value="true">
	...
	<a href="javascript:clearFormXX('userManageFormAddDis')">Clear Form</a><br>
    <a href="/moveTo.html?dest=<%=cancelPage%>">Cancel</a><br>

	<!--INPUT TYPE="HIDDEN" id="_ffd_wpid" name="wpid" value=" _wpId " -->

</form>
<span id="resultDisplayUserManage"></span>
<a href="javascript:backToXX('userManageFormAddDis','resultDisplayUserManage')">show back</a><br>
<hr/>
