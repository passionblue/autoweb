...
<div id="partitionFormFrame_gen_flow_confirm_<%= catchString %>" class="partitionFormFrame"><!-- This is loaded from /GenFlowConfirm_artition.jsp -->

	<script type="text/javascript">
		function sendForm_gen_flow_confirm_<%= catchString %>() { 
	...
	<a id="ajaxSubmit<%= catchString %>" href="javascript:sendForm_gen_flow_confirm_<%= catchString %>;">Submit</a>
	<br>
	<br>
