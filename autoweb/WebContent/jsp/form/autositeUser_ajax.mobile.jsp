...
<% 
    ...
    String _pageless_sessionValue= WebUtil.display((String)reqParams.get("pagelessSession"));
...
%>
	...
	<div id="autositeUserFrame<%=_AutositeUser.getId() %>" >
		...
		<div id="pagelessSession" >
			pagelessSession:<%= _AutositeUser.getPagelessSession() %>
		</div>
		<div id="opt1" >
...
<form name="autositeUserFormAdd" method="POST" action="/autositeUserAction.html" id="autositeUserFormAdd">
    ...
    <div id="autositeUserForm_pagelessSession_dropdown" class="formFieldDropDown" >       
        <select name="pagelessSession" id="_ffd_pagelessSession">
...
<form name="autositeUserFormAddDis" method="POST" action="/autositeUserAction.html" id="autositeUserFormAddDis">
	<INPUT TYPE="HIDDEN" NAME="add" value="true">
		...
		<br/>
		 <div class="ajaxFormLabel"> Pageless Session</div>
        <select name="pagelessSession" id="pagelessSession">
        <option value="0" <%=HtmlUtil.getOptionSelect("0", _pageless_sessionValue)%>>No</option>
        <option value="1" <%=HtmlUtil.getOptionSelect("1", _pageless_sessionValue)%>>Yes</option>
        </select><span></span>
		<br/>
