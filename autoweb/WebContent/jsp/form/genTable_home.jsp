...
<script type="text/javascript" src="/genTableAction.html?ajxr=getscriptform"></script>
...
<TABLE border="1" width="100%" bgcolor="transparent" align="center" cellspacing="0" style="border-width: 1px; border-style: solid">
    ...
    <TR>
        <TD>
        	AJAX | 
			<a href="/genTableAction.html?ajxr=getmodalform&formfieldlist=&forcehiddenlist=" rel="facebox"> open form (custom field list)</a> |
			<a href="/genTableAction.html?ajxr=getmodalform" 			rel="facebox"> open form</a> |
			<a href="/genTableAction.html?ajxr=getlisthtml"  			rel="facebox"> getlisthtml</a> |
			<a href="/genTableAction.html?ajxr=getlistjson"  			rel="facebox"> getlistjson</a> |
			<a href="/genTableAction.html?ajxr=getjson&ajaxOutArg=first" rel="facebox"> getjson first</a> |
			<a href="/genTableAction.html?ajxr=getjson&ajaxOutArg=last" 	rel="facebox"> getjson last</a> |
			<a href="/genTableAction.html?ajxr=getlistdata" 				rel="facebox"> getlistdata</a> |
...
<TR bgcolor="#ffffff" valign="top">
	...
	<form name="genTableFormEditField_Country_<%=_GenTable.getId()%>" method="get" action="/genTableAction.html" >
		...
		<br>
			...
			<a id="update_field_by_ajax" href="#" rel="country">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="country">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="country">	Update Test With Get2Field value </a><br>
	...
	<form name="genTableFormEditField_Age_<%=_GenTable.getId()%>" method="get" action="/genTableAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="age">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="age">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="age">	Update Test With Get2Field value </a><br>
	...
	<form name="genTableFormEditField_Comments_<%=_GenTable.getId()%>" method="get" action="/genTableAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="comments">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="comments">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="comments">	Update Test With Get2Field value </a><br>
...
<script type="text/javascript">
	...
	function submit_cmd_command1(){
		location.href='/genTableAction.html?command1=true<%=HttpUrlUtil.getCommonUrlAppends(request)%>';
	}
	function submit_cmd_command2(){
		location.href='/genTableAction.html?command2=true<%=HttpUrlUtil.getCommonUrlAppends(request)%>';
	}
	function submit_cmd_command3(){
		location.href='/genTableAction.html?command3=true<%=HttpUrlUtil.getCommonUrlAppends(request)%>';
	}
	...
	$(document).ready(function(){
		...
		$("a#update_field_by_ajax").click(function () {
			...
			$ .ajax({
			   type: "GET",
		   		url: "/genTableAction.html?editfield=true&ajxr=getfieldbyname&id="+_id+"&"+_fieldName+"="+ _val+"&fieldname=" + _fieldName,
		...
		$("a#update_field_by_ajax_get2field").click(function () {
	    	...
	    	$ .ajax({
			   type: "GET",
		   		url: "/genTableAction.html?editfield=true&ajxr=get2field&id="+_id+"&"+_fieldName+"="+ _val,
				beforeSend: function(jqXHR, settings){
					//alert("sending");
				},
				complete: function(jqXHR, textStatus){
		...
		$("a#partition_test_ajax").click(function () {
			...
			$ .ajax({
			   type: "GET",
		   		url: "/partitionTo.html?fmt=getpart&partType=custom&partId=partition-gen-table",
		  		success: function(msg){ 
		     		alert(msg);
