...
<script type="text/javascript">
	...
	function open_edit_gen_form_flow_form(target){
		location.href='/v_gen_form_flow_form.html?cmd=edit&prv_returnPage=<%=PageViewUtil.getCurrentViewAlias(request)%>&id=' + target;
	}
	function delete_gen_form_flow_form(target){
		javascript:sendFormAjaxSimple('/genFormFlowAction.html?del=true&id='+target+'&ajaxRequest=true&ajaxOut=getModalStatus', false, updateVal,target);
	}
