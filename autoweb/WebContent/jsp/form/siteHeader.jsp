...
<script type="text/javascript" src="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getscriptform"></script>
...
<TABLE border="1" width="100%" bgcolor="transparent" align="center" cellspacing="0" style="border-width: 1px; border-style: solid">
    <TR>
        <TD>
            <a href="v_site_header_form.html?prv_returnPage=site_header_home"> Add New </a> |
            <a href="v_site_header_list.html?"> List Page </a> |
            <a href="v_site_header_ajax.html?"> Ajax Sampler </a> |
        </TD>
    </TR>
    <TR>
        <TD>
        	AJAX | 
			<a href="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getmodalform&formfieldlist=&forcehiddenlist=" rel="facebox"> open form</a> |
			<a href="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getmodalform" rel="facebox"> open form</a> |
			<a href="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getlisthtml" rel="facebox"> getlisthtml</a> |
			<a href="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getlistjson" rel="facebox"> getlistjson</a> |
			<a href="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getjson&ajaxOutArg=first" rel="facebox">getjson first</a> |
			<a href="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getjson&ajaxOutArg=last" rel="facebox">getjson last</a> |
			<a href="/siteHeaderAction.html?ajaxRequest=true&ajaxOut=getlistdata" rel="facebox">getlistdata</a> |
		</TD>        
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	    <div id="siteHeaderForm_asIs_label" style="font-size: normal normal bold 10px verdana;" >As Is </div>
    </td> 
    <td> 
	    <div id="siteHeaderForm_includeType_label" style="font-size: normal normal bold 10px verdana;" >Include Type </div>
    </td> 
    <td> 
	    <div id="siteHeaderForm_includeText_label" style="font-size: normal normal bold 10px verdana;" >Include Text </div>
    </td> 
	<td></td>
	<td></td>
</TR>
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	<form name="siteHeaderFormEditField_AsIs_<%=_SiteHeader.getId()%>" method="get" action="/siteHeaderAction.html" >


		<div id="siteHeaderForm_asIs_field">
	    <div id="siteHeaderForm_asIs_dropdown" class="formFieldDropDown" >       
	        <select name="asIs">
	        <option value="0" <%=HtmlUtil.getOptionSelect("0", _SiteHeader.getAsIs())%>>No</option>
	        <option value="1" <%=HtmlUtil.getOptionSelect("1", _SiteHeader.getAsIs())%>>Yes</option>
	        </select>
	    </div>      
		</div><div class="clear"></div>

		<br>
            <a id="formSubmit" href="javascript:document.siteHeaderFormEditField_AsIs_<%=_SiteHeader.getId()%>.submit();">Submit</a>

	<INPUT TYPE="HIDDEN" NAME="editfield" value="true">
	<INPUT TYPE="HIDDEN" NAME="id" value="<%=_SiteHeader.getId()%>">
	<INPUT TYPE="HIDDEN" NAME="returnPage" value="site_header_home">
	</form>
    ...
    <td> 
	<form name="siteHeaderFormEditField_IncludeType_<%=_SiteHeader.getId()%>" method="get" action="/siteHeaderAction.html" >
	    ...
	    <div id="siteHeaderForm_includeType_dropdown" class="formFieldDropDown" >       
	        ...
	        <!--option value="XX" <%=HtmlUtil.getOptionSelect("XX", _SiteHeader.getIncludeType())%>>XX</option-->
	        </select>  <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
            <a id="formSubmit" href="javascript:document.siteHeaderFormEditField_IncludeType_<%=_SiteHeader.getId()%>.submit();">Submit</a>
    ...
    <td> 
	<form name="siteHeaderFormEditField_IncludeText_<%=_SiteHeader.getId()%>" method="get" action="/siteHeaderAction.html" >


		<div id="siteHeaderForm_includeText_field">
	    <div id="siteHeaderForm_includeText_text" class="formFieldText" >       
	        <input id="field" type="text" size="20" name="includeText" value="<%=WebUtil.display(_SiteHeader.getIncludeText())%>"/> <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
            <a id="formSubmit" href="javascript:document.siteHeaderFormEditField_IncludeText_<%=_SiteHeader.getId()%>.submit();">Submit</a>
    ...
    <td>
    <form name="siteHeaderForm<%=_SiteHeader.getId()%>2" method="get" action="/v_site_header_form.html" >
        <a href="javascript:document.siteHeaderForm<%=_SiteHeader.getId()%>2.submit();">Edit</a>           
        <INPUT TYPE="HIDDEN" NAME="id" value="<%= _SiteHeader.getId() %>">
        <INPUT TYPE="HIDDEN" NAME="cmd" value="edit">
        <INPUT TYPE="HIDDEN" NAME="prv_returnPage" value="site_header_home">
    </form>
    <a href="javascript:;" title="Edit" class="deleteLink" onclick="edit_site_header_form('<%=_SiteHeader.getId()%>');">Edit</a>
    </td>

    <td>
    <a href="/siteHeaderAction.html?del=true&id=<%=_SiteHeader.getId()%>"> Delete </a><BR>
    <a href="javascript:;" title="Delete User" class="deleteLink" onclick="confirm_remove_site_header('<%=_SiteHeader.getId()%>');">DeleteWConfirm</a>
    </td>
</TR>
...
<script type="text/javascript">
	...
	function confirm_site_header(target, txt){
		$ .prompt(txt,{ 
	...
	function confirm_remove_site_header(target){
		$ .prompt('Are you sure you want to remove this?',{ 
			buttons:{Delete:true, Cancel:false},
			callback: function(v,m,f){
				if(v){
					location.href="/siteHeaderAction.html?del=true&id="+target;
				}
			}
		});
	}
