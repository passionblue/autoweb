...
<%
    ...
    String _wrap_dataValue= "";

%>

<div id="partitionFormFrame_test_wrap_<%= catchString %>" class="partitionFormFrame"><!-- This is loaded from /TestWrap_artition.jsp -->

	<script type="text/javascript">
		function sendForm_test_wrap_<%= catchString %>() { 
	...
	<a id="ajaxSubmit<%= catchString %>" href="javascript:sendForm_test_wrap_<%= catchString %>;">Submit</a>
	<br>
	<br>
