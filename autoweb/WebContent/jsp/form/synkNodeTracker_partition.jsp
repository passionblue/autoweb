...
<div id="partitionFormFrame_synk_node_tracker_<%= catchString %>" class="partitionFormFrame"><!-- This is loaded from /SynkNodeTracker_artition.jsp -->

	<script type="text/javascript">
		function sendForm_synk_node_tracker_<%= catchString %>() { 
	...
	<a id="ajaxSubmit<%= catchString %>" href="javascript:sendForm_synk_node_tracker_<%= catchString %>;">Submit</a>
	<br>
	<br>
