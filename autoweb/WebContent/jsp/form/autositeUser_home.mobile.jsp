...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	    <div id="autositeUserForm_pagelessSession_label" style="font-size: normal normal bold 10px verdana;" >Pageless Session </div>
    </td> 
    <td> 
...
<TR bgcolor="#ffffff" valign="top">
	...
	<form name="autositeUserFormEditField_UserType_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="userType">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="userType">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="userType">	Update Test With Get2Field value </a><br>
	...
	<form name="autositeUserFormEditField_Nickname_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="nickname">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="nickname">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="nickname">	Update Test With Get2Field value </a><br>
	...
	<form name="autositeUserFormEditField_TimeDisabled_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="timeDisabled">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="timeDisabled">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="timeDisabled">	Update Test With Get2Field value </a><br>
	...
	<form name="autositeUserFormEditField_Confirmed_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="confirmed">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="confirmed">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="confirmed">	Update Test With Get2Field value </a><br>
	...
	<form name="autositeUserFormEditField_TimeConfirmed_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="timeConfirmed">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="timeConfirmed">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="timeConfirmed">	Update Test With Get2Field value </a><br>
    ...
    <td> 
	<form name="autositeUserFormEditField_PagelessSession_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >


		<div id="autositeUserForm_pagelessSession_field">
	    <div id="autositeUserForm_pagelessSession_dropdown" class="formFieldDropDown" >       
	        <select name="pagelessSession">
	        <option value="0" <%=HtmlUtil.getOptionSelect("0", _AutositeUser.getPagelessSession())%>>No</option>
	        <option value="1" <%=HtmlUtil.getOptionSelect("1", _AutositeUser.getPagelessSession())%>>Yes</option>
	        </select>
	    </div>      
		</div><div class="clear"></div>

		<br>
			<div id="pagelessSession_<%= _AutositeUser.getId()%>"><%=_AutositeUser.getPagelessSession() %></div>
            <a id="formSubmit" href="javascript:document.autositeUserFormEditField_PagelessSession_<%=_AutositeUser.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_AutositeUser.getId()%>', 'pagelessSession', '<%=_AutositeUser.getPagelessSession()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="pagelessSession">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="pagelessSession">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="pagelessSession">	Update Test With Get2Field value </a><br>
	...
	<form name="autositeUserFormEditField_Opt1_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="opt1">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="opt1">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="opt1">	Update Test With Get2Field value </a><br>
	...
	<form name="autositeUserFormEditField_Opt2_<%=_AutositeUser.getId()%>" method="get" action="/autositeUserAction.html" >
		...
		<br>
			...
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="opt2">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="opt2">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="opt2">	Update Test With Get2Field value </a><br>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("a#update_field_by_ajax").click(function () {
			...
			$ .ajax({
			   type: "GET",
		   		url: "/autositeUserAction.html?editfield=true&ajxr=getfieldbyname&id="+_id+"&"+_fieldName+"="+ _val+"&fieldname=" + _fieldName,
		...
		$("a#update_field_by_ajax_open_reply").click(function () {
	    	...
	    	$ .ajax({
			   type: "GET",
		   		url: "/autositeUserAction.html?editfield=true&ajaxRequest=true&ajaxOut=getfieldbyname&id="+_id+"&"+_fieldName+"="+ _val+"&fieldname=" + _fieldName,
		...
		$("a#update_field_by_ajax_get2field").click(function () {
	    	...
	    	$ .ajax({
			   type: "GET",
		   		url: "/autositeUserAction.html?editfield=true&ajxr=get2field&id="+_id+"&"+_fieldName+"="+ _val,
				beforeSend: function(jqXHR, settings){
					//alert("sending");
				},
				complete: function(jqXHR, textStatus){
		...
		$("a#partition_test_ajax").click(function () {
			...
			$ .ajax({
			   type: "GET",
		   		url: "/partitionTo.html?fmt=getpart&partType=custom&partId=partition-autosite-user",
		  		success: function(msg){ 
		     		alert(msg);
