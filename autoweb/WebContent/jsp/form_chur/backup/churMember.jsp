...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	    <div id="churMemberForm_otherName2_label" style="font-size: normal normal bold 10px verdana;" >Other Name2 </div>
    </td> 
    <td> 
...
<%
    ...
    for(Iterator iter = list.iterator();iter.hasNext();) {
        ...
        fieldString += "\"" + _ChurMember.getFullName() + "\",";
%>
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	<form name="churMemberFormEditField_OtherName2_<%=_ChurMember.getId()%>" method="get" action="/churMemberAction.html" >


		<div id="churMemberForm_otherName2_field">
	    <div id="churMemberForm_otherName2_text" class="formFieldText" >       
	        <input id="field" type="text" size="20" name="otherName2" value="<%=WebUtil.display(_ChurMember.getOtherName())%>"/> <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
            <a id="formSubmit" href="javascript:document.churMemberFormEditField_OtherName2_<%=_ChurMember.getId()%>.submit();">Submit</a>
...
<%
    for(Iterator iter = list.iterator();iter.hasNext();) {
        ChurMember _ChurMember = (ChurMember) iter.next();
%>
	<option> <%= _ChurMember.getFullName() %>
<%
    }
%>
</select>
...
<br><input type="button" onClick="handleKeyUp(9999999);" value="Load All Matches">
</form>
</td>
</tr>
<tr><td valign="top">
