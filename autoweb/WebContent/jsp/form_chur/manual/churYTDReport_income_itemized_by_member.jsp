...
<%
	Map itemizedExpenseTotal = ChurReportUtil.getYearlyTotalIncomeAmountByMember(site.getId(), _selectedYear);
    ...
    for(Iterator it = itemizedExpenseTotal.keySet().iterator();it.hasNext();) {
		...
		ChurMember mem = ChurMemberDS.getInstance().getById(itemKey.longValue());
