...
<script type="text/javascript" src="/churIncomeAction.html?ajxr=getscriptform"></script>
...
<TABLE border="1" width="100%" bgcolor="transparent" align="center" cellspacing="0" style="border-width: 1px; border-style: solid">
    <TR>
        <TD>
            <a href="v_chur_income_form.html?prv_returnPage=chur_income_home"> Add New </a> |
    ...
    <TR>
        <TD>
        	AJAX | 
			<a href="/churIncomeAction.html?ajxr=getmodalform&formfieldlist=&forcehiddenlist=" rel="facebox"> open form (custom field list)</a> |
			<a href="/churIncomeAction.html?ajxr=getmodalform" 			rel="facebox"> open form</a> |
			<a href="/churIncomeAction.html?ajxr=getlisthtml"  			rel="facebox"> getlisthtml</a> |
			<a href="/churIncomeAction.html?ajxr=getlistjson"  			rel="facebox"> getlistjson</a> |
			<a href="/churIncomeAction.html?ajxr=getjson&ajaxOutArg=first" rel="facebox"> getjson first</a> |
			<a href="/churIncomeAction.html?ajxr=getjson&ajaxOutArg=last" 	rel="facebox"> getjson last</a> |
			<a href="/churIncomeAction.html?ajxr=getlistdata" 				rel="facebox"> getlistdata</a> |
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	    <div id="churIncomeForm_year_label" style="font-size: normal normal bold 10px verdana;" >Year </div>
    </td> 
    <td> 
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	<form name="churIncomeFormEditField_Year_<%=_ChurIncome.getId()%>" method="get" action="/churIncomeAction.html" >
	    ...
	    <div id="churIncomeForm_year_dropdown" class="formFieldDropDown" >       
	        ...
	        <!--option value="XX" <%=HtmlUtil.getOptionSelect("XX", _ChurIncome.getYear())%>>XX</option-->
	        </select>  <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
			<div id="year_<%= _ChurIncome.getId()%>"><%=_ChurIncome.getYear() %></div>
            <a id="formSubmit" href="javascript:document.churIncomeFormEditField_Year_<%=_ChurIncome.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_ChurIncome.getId()%>', 'year', '<%=_ChurIncome.getYear()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="year">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="year">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="year">	Update Test With Get2Field value </a><br>

	<INPUT TYPE="HIDDEN" NAME="editfield" value="true">
	<INPUT TYPE="HIDDEN" NAME="id" value="<%=_ChurIncome.getId()%>">
	<INPUT TYPE="HIDDEN" NAME="returnPage" value="chur_income_home">
	</form>
	...
	<form name="churIncomeFormEditField_Week_<%=_ChurIncome.getId()%>" method="get" action="/churIncomeAction.html" >
		...
		<br>
			<div id="week_<%= _ChurIncome.getId()%>"><%=_ChurIncome.getWeek() %></div>
            <a id="formSubmit" href="javascript:document.churIncomeFormEditField_Week_<%=_ChurIncome.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_ChurIncome.getId()%>', 'week', '<%=_ChurIncome.getWeek()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="week">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="week">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="week">	Update Test With Get2Field value </a><br>
	...
	<form name="churIncomeFormEditField_ChurMemberId_<%=_ChurIncome.getId()%>" method="get" action="/churIncomeAction.html" >
		...
		<br>
			<div id="churMemberId_<%= _ChurIncome.getId()%>"><%=_ChurIncome.getChurMemberId() %></div>
            <a id="formSubmit" href="javascript:document.churIncomeFormEditField_ChurMemberId_<%=_ChurIncome.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_ChurIncome.getId()%>', 'churMemberId', '<%=_ChurIncome.getChurMemberId()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="churMemberId">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="churMemberId">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="churMemberId">	Update Test With Get2Field value </a><br>
	...
	<form name="churIncomeFormEditField_IncomeItemId_<%=_ChurIncome.getId()%>" method="get" action="/churIncomeAction.html" >
		...
		<br>
			<div id="incomeItemId_<%= _ChurIncome.getId()%>"><%=_ChurIncome.getIncomeItemId() %></div>
            <a id="formSubmit" href="javascript:document.churIncomeFormEditField_IncomeItemId_<%=_ChurIncome.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_ChurIncome.getId()%>', 'incomeItemId', '<%=_ChurIncome.getIncomeItemId()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="incomeItemId">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="incomeItemId">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="incomeItemId">	Update Test With Get2Field value </a><br>
	...
	<form name="churIncomeFormEditField_Ammount_<%=_ChurIncome.getId()%>" method="get" action="/churIncomeAction.html" >
		...
		<br>
			<div id="ammount_<%= _ChurIncome.getId()%>"><%=_ChurIncome.getAmmount() %></div>
            <a id="formSubmit" href="javascript:document.churIncomeFormEditField_Ammount_<%=_ChurIncome.getId()%>.submit();">Submit</a>
            <br>
		    <a href="javascript:;" title="UpdatePrompt" class="deleteLink" onclick="update_cleaner_pickup_field_dialog('<%=_ChurIncome.getId()%>', 'ammount', '<%=_ChurIncome.getAmmount()%>');">
	    	EditPrompt
	    	</a>
			<br> <!-- update by ajax call -->
			<a id="update_field_by_ajax" href="#" rel="ammount">	Update </a><br>
			<a id="update_field_by_ajax_open_reply" href="#" rel="ammount">	Update </a><br>
			<a id="update_field_by_ajax_get2field" href="#" rel="ammount">	Update Test With Get2Field value </a><br>
    ...
    <form name="churIncomeForm<%=_ChurIncome.getId()%>2" method="get" action="/v_chur_income_form.html" >
        ...
        <INPUT TYPE="HIDDEN" NAME="prv_returnPage" value="chur_income_home">
    </form>
...
<script type="text/javascript">
	...
	function edit_chur_income_form(target){
		location.href='/v_chur_income_form.html?cmd=edit&prv_returnPage=chur_income_home&id=' + target;
	}
			...
			callback: function(v,m,f){
				if (v){
					if (f.myname == "") {
						...
						location.href="/churIncomeAction.html?editfield=true&returnPage=cleaner_pickup_home&id="+targetId+"&"+targetField +"=" +f.myname;
					}
				}
				return true;
			}
	...
	$(document).ready(function(){
		...
		$("a#update_field_by_ajax").click(function () {
			...
			$ .ajax({
			   type: "GET",
		   		url: "/churIncomeAction.html?editfield=true&ajxr=getfieldbyname&id="+_id+"&"+_fieldName+"="+ _val+"&fieldname=" + _fieldName,
		...
		$("a#update_field_by_ajax_open_reply").click(function () {
	    	...
	    	$ .ajax({
			   type: "GET",
		   		url: "/churIncomeAction.html?editfield=true&ajaxRequest=true&ajaxOut=getfieldbyname&id="+_id+"&"+_fieldName+"="+ _val+"&fieldname=" + _fieldName,
		...
		$("a#update_field_by_ajax_get2field").click(function () {
	    	...
	    	$ .ajax({
			   type: "GET",
		   		url: "/churIncomeAction.html?editfield=true&ajxr=get2field&id="+_id+"&"+_fieldName+"="+ _val,
				beforeSend: function(jqXHR, settings){
					//alert("sending");
				},
				complete: function(jqXHR, textStatus){
		...
		$("a#partition_test_ajax").click(function () {
			...
			$ .ajax({
			   type: "GET",
		   		url: "/partitionTo.html?fmt=getpart&partType=custom&partId=partition-chur-income",
		  		success: function(msg){ 
		     		alert(msg);
