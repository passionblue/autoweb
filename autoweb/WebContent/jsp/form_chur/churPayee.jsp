...
<script type="text/javascript" src="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getscriptform"></script>
...
<TABLE border="1" width="100%" bgcolor="transparent" align="center" cellspacing="0" style="border-width: 1px; border-style: solid">
    <TR>
        <TD>
            <a href="v_chur_payee_form.html?prv_returnPage=chur_payee_home"> Add New </a> |
            <a href="v_chur_payee_list.html?"> List Page </a> |
            <a href="v_chur_payee_ajax.html?"> Ajax Sampler </a> |
        </TD>
    </TR>
    <TR>
        <TD>
        	AJAX | 
			<a href="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getmodalform&formfieldlist=&forcehiddenlist=" rel="facebox"> open form</a> |
			<a href="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getmodalform" rel="facebox"> open form</a> |
			<a href="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getlisthtml" rel="facebox"> getlisthtml</a> |
			<a href="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getlistjson" rel="facebox"> getlistjson</a> |
			<a href="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getjson&ajaxOutArg=first" rel="facebox">getjson first</a> |
			<a href="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getjson&ajaxOutArg=last" rel="facebox">getjson last</a> |
			<a href="/churPayeeAction.html?ajaxRequest=true&ajaxOut=getlistdata" rel="facebox">getlistdata</a> |
		</TD>        
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	    <div id="churPayeeForm_title_label" style="font-size: normal normal bold 10px verdana;" >Title </div>
    </td> 
    <td> 
	    <div id="churPayeeForm_remark_label" style="font-size: normal normal bold 10px verdana;" >Remark </div>
    </td> 
	<td></td>
	<td></td>
</TR>
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> 
	<form name="churPayeeFormEditField_Title_<%=_ChurPayee.getId()%>" method="get" action="/churPayeeAction.html" >


		<div id="churPayeeForm_title_field">
	    <div id="churPayeeForm_title_text" class="formFieldText" >       
	        <input id="field" type="text" size="20" name="title" value="<%=WebUtil.display(_ChurPayee.getTitle())%>"/> <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
            <a id="formSubmit" href="javascript:document.churPayeeFormEditField_Title_<%=_ChurPayee.getId()%>.submit();">Submit</a>

	<INPUT TYPE="HIDDEN" NAME="editfield" value="true">
	<INPUT TYPE="HIDDEN" NAME="id" value="<%=_ChurPayee.getId()%>">
	<INPUT TYPE="HIDDEN" NAME="returnPage" value="chur_payee_home">
	</form>
    ...
    <td> 
	<form name="churPayeeFormEditField_Remark_<%=_ChurPayee.getId()%>" method="get" action="/churPayeeAction.html" >


		<div id="churPayeeForm_remark_field">
	    <div id="churPayeeForm_remark_text" class="formFieldText" >       
	        <input id="field" type="text" size="20" name="remark" value="<%=WebUtil.display(_ChurPayee.getRemark())%>"/> <span></span>
	    </div>      
		</div><div class="clear"></div>

		<br>
            <a id="formSubmit" href="javascript:document.churPayeeFormEditField_Remark_<%=_ChurPayee.getId()%>.submit();">Submit</a>
    ...
    <td>
    <form name="churPayeeForm<%=_ChurPayee.getId()%>2" method="get" action="/v_chur_payee_form.html" >
        <a href="javascript:document.churPayeeForm<%=_ChurPayee.getId()%>2.submit();">Edit</a>           
        <INPUT TYPE="HIDDEN" NAME="id" value="<%= _ChurPayee.getId() %>">
        <INPUT TYPE="HIDDEN" NAME="cmd" value="edit">
        <INPUT TYPE="HIDDEN" NAME="prv_returnPage" value="chur_payee_home">
    </form>
    <a href="javascript:;" title="Edit" class="deleteLink" onclick="edit_chur_payee_form('<%=_ChurPayee.getId()%>');">Edit</a>
    </td>

    <td>
    <a href="/churPayeeAction.html?del=true&id=<%=_ChurPayee.getId()%>"> Delete </a><BR>
    <a href="javascript:;" title="Delete User" class="deleteLink" onclick="confirm_remove_chur_payee('<%=_ChurPayee.getId()%>');">DeleteWConfirm</a>
    </td>
</TR>
...
<script type="text/javascript">
	...
	function confirm_chur_payee(target, txt){
		$ .prompt(txt,{ 
	...
	function confirm_remove_chur_payee(target){
		$ .prompt('Are you sure you want to remove this?',{ 
			buttons:{Delete:true, Cancel:false},
			callback: function(v,m,f){
				if(v){
					location.href="/churPayeeAction.html?del=true&id="+target;
				}
			}
		});
	}
