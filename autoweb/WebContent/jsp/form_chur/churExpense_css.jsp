...
<%	} %>            
    ...
    <div id="churExpenseForm_checkNumber_text" class="formFieldText" >       
        <input id="checkNumber" class="field" type="text" size="70" name="checkNumber" value="<%=WebUtil.display(_check_numberValue)%>"/> <span></span>
    </div>      
	</div><div class="clear"></div>
	...
	<div id="churExpenseForm_timeUpdated_field" class="formFieldFrame">
...
<% 	} %>
	...
	<td> <a href="javascript:sendFormAjaxSimple('/churExpenseAction.html?del=true&id=<%=_oChurExpense.getId() %>&ajaxRequest=true&ajaxOut=getModalStatus', false, updateVal,<%=_oChurExpense.getId()%> );"><img id="deleteRow" src="/images/icons/led/cross.png"/></a></td>
	<td>
