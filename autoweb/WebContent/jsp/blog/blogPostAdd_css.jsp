...
<form name="blogPostForm" method="post" action="/blogPostAction.html" >
    ...
    <div id="blogPostForm_subject_label" class="formRequiredLabel" >Subject* </div>
    <div id="blogPostForm_subject_text" class="formFieldText" > <span></span>      
        <input id="requiredField" type="text" size="30" name="subject" value="<%=WebUtil.display(_subjectValue)%>"/> 
    </div>      
    ...
    <div id="blogPostForm_content_label" class="formRequiredLabel" >Content* </div>
    <div id="blogPostForm_content_textarea" class="formFieldText" >       
        <span></span>
    ...
    <div id="blogPostForm_postType_label" class="formLabel" >Post Type </div>
    ...
    <div id="blogPostForm_author_label" class="formLabel" >Author </div>
    <div id="blogPostForm_author_text" class="formFieldText" > <span></span>      
        <input id="field" type="text" size="30" name="author" value="<%=WebUtil.display(_authorValue)%>"/>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="blogPostForm_contentImage_label" class="formLabel" >Content Image </div>
    <div id="blogPostForm_contentImage_text" class="formFieldText" > <span></span>      
        <input id="field" type="text" size="30" name="contentImage" value="<%=WebUtil.display(_content_imageValue)%>"/>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="blogPostForm_imageUrl1_label" class="formLabel" >Image Url1 </div>
    <div id="blogPostForm_imageUrl1_text" class="formFieldText" > <span></span>      
    ...
    <div id="blogPostForm_imageUrl2_label" class="formLabel" >Image Url2 </div>
    <div id="blogPostForm_imageUrl2_text" class="formFieldText" > <span></span>      
    ...
    <div id="blogPostForm_tags_label" class="formLabel" >Tags </div>
    <div id="blogPostForm_tags_text" class="formFieldText" > <span></span>      
        <input id="field" type="text" size="30" name="tags" value="<%=WebUtil.display(_tagsValue)%>"/>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="blogPostForm_shorcutUrl_label" class="formLabel" >Shorcut Url </div>
    <div id="blogPostForm_shorcutUrl_text" class="formFieldText" > <span></span>      
        <input id="field" type="text" size="30" name="shorcutUrl" value="<%=WebUtil.display(_shorcut_urlValue)%>"/>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="blogPostForm_hide_label" class="formLabel" >Hide </div>
    <div id="blogPostForm_hide_dropdown" class="formFieldDropDown" >       
        ...
        <div id="blogPostForm_submit" class="formSubmit" >       
            <a id="formSubmit" href="javascript:document.blogPostForm.submit();">Submit</a>
        </div>      
