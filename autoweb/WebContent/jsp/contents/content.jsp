...
<%
	...
	List list = ContentDS.getInstance().getBySiteId(site.getId());
 	...
 	for(Iterator iter = list.iterator();iter.hasNext();) {
		...
		String data = _Content.getCategory();
...
<TR bgcolor="#ffffff" valign="top">
    ...
    <td> <%= WebUtil.display(_Content.getHide()) %></td>
    <td> <%= WebUtil.display(_Content.getShowHome()) %></td>
    ...
    <td> <%= WebUtil.display(_Content.getInHtml()) %></td>
