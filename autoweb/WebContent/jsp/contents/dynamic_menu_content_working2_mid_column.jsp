...
<br><br>
	<a href="t_panel_add.html?prv_columnNum=<%=columnNumForPage%>&prv_pageOnly=1&prv_align=1&prv_topSpace=0&prv_pageId=<%=dynPage.getId()%>" class="pageMenuText">Add Panel</a> | 
	<% if (pageConfig == null){ %>
