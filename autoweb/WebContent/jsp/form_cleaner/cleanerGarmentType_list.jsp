...
<a href="t_cleaner_garment_type_form.html?prv_returnPage=cleaner_garment_type_home"> Add New 2</a> <br>
<br/>
...
<script type="text/javascript">
	$(document).ready(function(){
		setInterval(function(){
			$ .ajax({
			   type: "GET",
		   		url: "/cleanerGarmentTypeAction.html?ajaxRequest=true&ajaxOut=hb",
