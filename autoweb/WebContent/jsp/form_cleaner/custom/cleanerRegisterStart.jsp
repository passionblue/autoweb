...
<% 
	...
	boolean subsiteEnable = WebUtil.isTrue(site.getSubdomainEnable());
...
<form name="cleanerRegisterStartForm_Form" method="POST" action="/cleanerRegisterStartAction.html" id="cleanerRegisterStartForm_Form">
    ...
    <div id="cleanerRegisterStartForm_siteName_text" class="formFieldText" >       
        <input id="siteName" class="requiredField" type="text" size="30" name="siteName" value="<%=WebUtil.display(_site_nameValue)%>" <%= subsiteEnable?"":"disabled"%> /> <span></span>
    </div>      
    ...
    <div id="cleanerRegisterStartForm_email_text" class="formFieldText" >       
        <input id="email" class="requiredField" type="text" size="70" name="email" value="<%=WebUtil.display(_emailValue)%>"  <%= subsiteEnable?"":"disabled"%>  /> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="cleanerRegisterStartForm_password_text" class="formFieldText" >       
        <input id="password" class="requiredField" type="password" size="30" name="password" value="<%=WebUtil.display(_passwordValue)%>"  <%= subsiteEnable?"":"disabled"%> /> <span></span>
    </div>      
	</div><div class="clear"></div>
    ...
    <div id="cleanerRegisterStartForm_passwordRepeat_text" class="formFieldText" >       
        <input id="passwordRepeat" class="requiredField" type="password" size="30" name="passwordRepeat" value="<%=WebUtil.display(_password_repeatValue)%>" <%= subsiteEnable?"":"disabled"%> /> <span></span>
    </div>      
	</div><div class="clear"></div>
