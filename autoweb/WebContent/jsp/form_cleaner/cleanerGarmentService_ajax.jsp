...
<a href="/v_cleaner_garment_service_home.html"> CleanerGarmentService Home </a>
<%
	
	List list = null;
	list = CleanerGarmentServiceDS.getInstance().getBySiteId(site.getId());

%>

<div id="cleanerGarmentServiceList"> 
<%
	for(Iterator iter = list.iterator();iter.hasNext();){
		CleanerGarmentService _CleanerGarmentService = (CleanerGarmentService) iter.next();	
%>

	<div id="cleanerGarmentServiceFrame<%=_CleanerGarmentService.getId() %>" >

		<div id="title" >
			title:<%= _CleanerGarmentService.getTitle() %>
		</div>
		<div id="note" >
			note:<%= _CleanerGarmentService.getNote() %>
		</div>
		<div id="imagePath" >
			imagePath:<%= _CleanerGarmentService.getImagePath() %>
		</div>
		<div>
		<a id="cleanerGarmentServiceDeleteButton" href="javascript:deleteThis('/cleanerGarmentServiceAction.html',<%= _CleanerGarmentService.getId()%>,'cleanerGarmentServiceFrame<%=_CleanerGarmentService.getId()%>' );" > 
...
<form name="cleanerGarmentServiceFormAdd" method="POST" action="/cleanerGarmentServiceAction.html" id="cleanerGarmentServiceFormAdd">
    ...
    <div id="cleanerGarmentServiceForm_imagePath_text" class="formFieldText" >       
        ...
        <div id="cleanerGarmentServiceFormEdit_submit" class="formSubmit" >       
            <a id="formSubmit_ajax" href="javascript:sendFormAjax2('/cleanerGarmentServiceAction.html', 'cleanerGarmentServiceFormAdd', 'formSubmit_ajax', 'cleanerGarmentService');">Submit</a>
        </div> 
...
function responseCallback(data){
	document.getElementById("resultDisplayCleanerGarmentService").innerHTML = data;
}

function sendRequest(){
	xmlhttpPostXX('cleanerGarmentServiceFormAddDis','/cleanerGarmentServiceAction.html', 'resultDisplayCleanerGarmentService', '${ajax_response_fields}', responseCallback);
}
</script>



<form name="cleanerGarmentServiceFormAddDis" method="POST" action="/cleanerGarmentServiceAction.html" id="cleanerGarmentServiceFormAddDis">
	<INPUT TYPE="HIDDEN" NAME="add" value="true">
	...
	<a href="javascript:clearFormXX('cleanerGarmentServiceFormAddDis')">Clear Form</a><br>
    <a href="/moveTo.html?dest=<%=cancelPage%>">Cancel</a><br>

	<!--INPUT TYPE="HIDDEN" id="_ffd_wpid" name="wpid" value=" _wpId " -->

</form>
<span id="resultDisplayCleanerGarmentService"></span>
<a href="javascript:backToXX('cleanerGarmentServiceFormAddDis','resultDisplayCleanerGarmentService')">show back</a><br>
<hr/>
