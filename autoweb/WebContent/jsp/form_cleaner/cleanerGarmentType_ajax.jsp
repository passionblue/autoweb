...
<a href="/v_cleaner_garment_type_home.html"> CleanerGarmentType Home </a>
<%
	
	List list = null;
	list = CleanerGarmentTypeDS.getInstance().getBySiteId(site.getId());

%>

<div id="cleanerGarmentTypeList"> 
<%
	for(Iterator iter = list.iterator();iter.hasNext();){
		CleanerGarmentType _CleanerGarmentType = (CleanerGarmentType) iter.next();	
%>

	<div id="cleanerGarmentTypeFrame<%=_CleanerGarmentType.getId() %>" >

		<div id="title" >
			title:<%= _CleanerGarmentType.getTitle() %>
		</div>
		<div id="imagePath" >
			imagePath:<%= _CleanerGarmentType.getImagePath() %>
		</div>
		<div>
		<a id="cleanerGarmentTypeDeleteButton" href="javascript:deleteThis('/cleanerGarmentTypeAction.html',<%= _CleanerGarmentType.getId()%>,'cleanerGarmentTypeFrame<%=_CleanerGarmentType.getId()%>' );" > 
...
<form name="cleanerGarmentTypeFormAdd" method="POST" action="/cleanerGarmentTypeAction.html" id="cleanerGarmentTypeFormAdd">
    ...
    <div id="cleanerGarmentTypeForm_imagePath_text" class="formFieldText" >       
        ...
        <div id="cleanerGarmentTypeFormEdit_submit" class="formSubmit" >       
            <a id="formSubmit_ajax" href="javascript:sendFormAjax2('/cleanerGarmentTypeAction.html', 'cleanerGarmentTypeFormAdd', 'formSubmit_ajax', 'cleanerGarmentType');">Submit</a>
        </div> 
...
function responseCallback(data){
	document.getElementById("resultDisplayCleanerGarmentType").innerHTML = data;
}

function sendRequest(){
	xmlhttpPostXX('cleanerGarmentTypeFormAddDis','/cleanerGarmentTypeAction.html', 'resultDisplayCleanerGarmentType', '${ajax_response_fields}', responseCallback);
}
</script>



<form name="cleanerGarmentTypeFormAddDis" method="POST" action="/cleanerGarmentTypeAction.html" id="cleanerGarmentTypeFormAddDis">
	<INPUT TYPE="HIDDEN" NAME="add" value="true">
	...
	<a href="javascript:clearFormXX('cleanerGarmentTypeFormAddDis')">Clear Form</a><br>
    <a href="/moveTo.html?dest=<%=cancelPage%>">Cancel</a><br>

	<!--INPUT TYPE="HIDDEN" id="_ffd_wpid" name="wpid" value=" _wpId " -->

</form>
<span id="resultDisplayCleanerGarmentType"></span>
<a href="javascript:backToXX('cleanerGarmentTypeFormAddDis','resultDisplayCleanerGarmentType')">show back</a><br>
<hr/>
