...
<div id="partitionFormFrame_cleaner_garment_type_<%= catchString %>" class="partitionFormFrame"><!-- This is loaded from /CleanerGarmentType_artition.jsp -->

	<script type="text/javascript">
		function sendForm_cleaner_garment_type_<%= catchString %>() { 
	...
	<a id="ajaxSubmit<%= catchString %>" href="javascript:sendForm_cleaner_garment_type_<%= catchString %>;">Submit</a>
	<br>
	<br>
