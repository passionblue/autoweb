							 	...
							 	function ()
									{
										...
										//>>MOD<<
										if (this.displayProc){
											td.innerHTML = this.displayProc(row);
											//alert($(this).attr('axis') + ":" + td.innerHTML);
											this.rowData = new Array();
											for (idx=0;idx<row.cell.length;idx++){
												this.rowData[idx] = row.cell[idx];
											}
											//alert(this.rowData);
										}
							...
							.click(
								function (e) 
									{ 
										...
										//>>MOD
										if(typeof rowClickProcess == 'function') {
											rowClickProcess(this.rowData);
										}
									}
							)
							.mousedown(
			...
			for (i=0;i<p.colModel.length;i++)
				{
					...
					//>>MOD<<
					// Column data process was added by me. 
					if (cm.displayProc)
					{
						th.displayProc = cm.displayProc;
					}
					//>><<
					$(tr).append(th);
				}
