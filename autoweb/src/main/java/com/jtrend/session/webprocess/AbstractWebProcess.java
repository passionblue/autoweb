...
public class AbstractWebProcess implements WebProcess {
    ...
    public AbstractWebProcess(int totalStage, long life, String arg, boolean reprocessible) {
        ...
        m_life = life;
        m_arg = arg;
        m_allowReprocess = reprocessible;
    ...
    public AbstractWebProcess(int totalStage) {
        this(totalStage, 1800000, null, false);
    }    
    
    public AbstractWebProcess() {
        this(1, 1800000, null, false);
    }    

    public AbstractWebProcess(String arg) {
        this(1, 1800000, arg, false);
    }    
    ...
    public boolean isAllowReprocess() {
        return m_allowReprocess;
    }

    public void setAllowReprocess(boolean allowReprocess) {
        m_allowReprocess = allowReprocess;
    }

    private static Logger m_logger = Logger.getLogger(AbstractWebProcess.class);
