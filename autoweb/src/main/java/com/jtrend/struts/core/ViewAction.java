 ...
 * @struts.action-forward name="success" path="/jsp/pages/Layout.jsp" contextRelative="true"
 */
public class ViewAction extends JtrendAction {
    /*
     * Generated Methods
     */
    ...
    private static Logger m_logger = Logger.getLogger(ViewAction.class);
}
