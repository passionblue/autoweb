...
//        String args2[] = new String[]{"PushGoDev.p12", "joshua", "fb6b71488c8aa12d85f6f14dbf58a1e68e163e1f5c7660417ecf15616977311c"};
//        
//        
//        /* Verify that the test is being invoked  */
//        if (!verifyCorrectUsage(NotificationTest.class, args2, "keystore-path", "keystore-password", "device-token", "[production|sandbox]", "[complex|simple|threads]", "[#devices]", "[#threads]")) return;
//
...
//        }
    ...
    public static void pushTestForDevice(String message, String deviceId) throws CommunicationException, KeystoreException, InvalidDeviceTokenFormatException {
        
        String rootDir = UploadResourceManager.Instance().getRootDir();
        String args2[] = new String[]{rootDir + File.separator + "PushGoDev.p12", "joshua", deviceId}; // ipad retina chiuchiu
        try {
            pushTest(args2, message);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }    
    
    private static void pushTest(String message) throws CommunicationException, KeystoreException, InvalidDeviceTokenFormatException {
//        String args2[] = new String[]{"PushGoDev.p12", "joshua", "fb6b71488c8aa12d85f6f14dbf58a1e68e163e1f5c7660417ecf15616977311c"}; // ipad2
        String args2[] = new String[]{"PushGoDev.p12", "joshua", "1d18dee0adc82408487c5f4e7ab4c3d55c3d3ccaeb7197bab42e3bf1ee8d9a37"}; // ipad retina chiuchiu
        try {
            pushTest(args2, message);
        } catch (Exception e) {
            e.printStackTrace();
     ...
     */
    private static void pushTest(String[] args, String mesasge) throws CommunicationException, KeystoreException, InvalidDeviceTokenFormatException {
        ...
        if (simple) {
            ...
            //Working
//             Push.alert(mesasge, keystore, password, production, token);
            
//            Push.sound("chime", keystore, password, production, token);

             //printPushedNotifications(notifications);
             List<PushedNotification> notifications = Push.payload(createComplexPayload(mesasge), keystore, password, production, token);
             
            //List<Device> deviceList = new ArrayList<Device>(1);
            //deviceList.add(new BasicDevice("fb6b71488c8aa12d85f6f14dbf58a1e68e163e1f5c7660417ecf15616977311c"));
            //Push.badge(0, keystore, password, production, deviceList);
    ...
    private static Payload createComplexPayload(String message) {
        ...
        try {
            ...
            complexPayload.addCustomAlertBody(message);
