package com.autosite.test.apns;


// This is sample class to test java-apns. it is working but the jar that it uses has conflict of slf4j
...
//        ApnsService service =
//                APNS.newService()
//                .withCert("c:\\Downloads\\PushGoDev.p12", "joshua")
//                .withSandboxDestination()
//                .build();        
//        
//        
//        String payload = APNS.newPayload().alertBody("Can't be simpler than this!").build();
//        String token = "fb6b71488c8aa12d85f6f14dbf58a1e68e163e1f5c7660417ecf15616977311c";
//        service.push(token, payload);
//        
//        
//        
////        String []arg = new String[]{"p", "PushGo.p12", "joshua", "fb6b71488c8aa12d85f6f14dbf58a1e68e163e1f5c7660417ecf15616977311c"};
////        main2(arg);
//    }
//    
//    public static void main2(final String[] args) throws InvalidSSLConfig, FileNotFoundException {
//        if (args.length != 4) {
