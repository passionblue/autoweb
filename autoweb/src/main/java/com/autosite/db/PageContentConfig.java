...
/**
 * PageContentConfig entity. @author MyEclipse Persistence Tools
 */

public class PageContentConfig extends com.autosite.db.BaseAutositeDataObject implements java.io.Serializable {
    ...
    /** default constructor */
    public PageContentConfig() {
    }

    /** minimal constructor */
    public PageContentConfig(long siteId, long contentId, int hideMenu, int hideMid, int hideAd, Timestamp timeCreated, Timestamp timeUpdated) {
        this.siteId = siteId;
    ...
    /** full constructor */
    public PageContentConfig(long siteId, long contentId, int contentType, int sortType, int arrangeType, String pageCss, String pageScript, String pageCssImports, String pageScriptImports,
            int hideMenu, int hideMid, int hideAd, long styleId, long contentStyleSetId, String headerMeta, String headerLink, Timestamp timeCreated, Timestamp timeUpdated) {
        this.siteId = siteId;
        this.contentId = contentId;
