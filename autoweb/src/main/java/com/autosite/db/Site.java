...
public class Site extends com.autosite.db.BaseAutositeDataObject implements java.io.Serializable {
    ...
    /** minimal constructor */
    public Site(String siteUrl, long accountId, Timestamp createdTime) {
    ...
    /** full constructor */
    public Site(String siteUrl, long accountId, Timestamp createdTime, String siteGroup, int registered, int onSale, int superAdminEnable, int siteRegisterEnable, int subdomainEnable,
