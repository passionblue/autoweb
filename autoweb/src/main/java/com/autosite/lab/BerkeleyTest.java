 ...
 *
 * $Id: HelloDatabaseWorld.java,v 1.23.2.1 2007/02/01 14:49:31 cwl Exp $
 */
 ...
 * @author Mark Hayes
 */
public class BerkeleyTest implements TransactionWorker {
    ...
    public static void main(String[] argv)
        ...
        BerkeleyTest worker = new BerkeleyTest(env);
    ...
    private BerkeleyTest(Environment env)
        throws Exception {
