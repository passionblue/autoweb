package com.autosite.lab.lucene;
...
public class SearchFiles {
    ...
    private static Query computeTopTermQuery(String dir) throws Exception {
...
//        Collections.sort(termlist, new ReverseComparator<String>(new ByValueComparator<String, Integer>(frequencyMap)));
    ...
    public static void main(String[] args) throws Exception  {
        SearchFiles.computeTopTermQuery("C:\\OpenServerNoSql\\data\\lucene\\index_lucene_sources_test");
    }
    
    /** Simple command-line based search demo. */
    public static void main2(String[] args) throws Exception {
        String usage = "Usage:\tjava org.apache.lucene.demo.SearchFiles [-index dir] [-field f] [-repeat n] [-queries file] [-query string] [-raw] [-paging hitsPerPage]\n\nSee http://lucene.apache.org/core/4_1_0/o/ for details.";
