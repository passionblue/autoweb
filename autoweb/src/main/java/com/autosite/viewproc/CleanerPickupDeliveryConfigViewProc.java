...
*/
public class CleanerPickupDeliveryConfigViewProc implements ViewProc{

    public String getName() {
        return "CleanerPickupDeliveryConfigViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerPickupDeliveryConfigViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerPickupDeliveryConfigViewProc.class);
}
