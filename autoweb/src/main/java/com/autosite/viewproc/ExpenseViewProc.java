...
*/
public class ExpenseViewProc implements ViewProc{

    public String getName() {
        return "ExpenseViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ExpenseViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ExpenseViewProc.class);
}
