...
*/
public class ExpenseCategoryViewProc implements ViewProc{

    public String getName() {
        return "ExpenseCategoryViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ExpenseCategoryViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ExpenseCategoryViewProc.class);
}
