...
*/
public class AutositeSessionContextEntityViewProc implements ViewProc{

    public String getName() {
        return "AutositeSessionContextEntityViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(AutositeSessionContextEntityViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(AutositeSessionContextEntityViewProc.class);
}
