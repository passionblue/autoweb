...
*/
public class CleanerTicketViewProc implements ViewProc{

    public String getName() {
        return "CleanerTicketViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerTicketViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerTicketViewProc.class);
}
