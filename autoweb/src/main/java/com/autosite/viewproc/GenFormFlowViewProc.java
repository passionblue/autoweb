...
*/
public class GenFormFlowViewProc implements ViewProc{

    public String getName() {
        return "GenFormFlowViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(GenFormFlowViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(GenFormFlowViewProc.class);
}
