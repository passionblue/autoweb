...
*/
public class TestFacadeViewProc implements ViewProc{

    public String getName() {
        return "TestFacadeViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(TestFacadeViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(TestFacadeViewProc.class);
}
