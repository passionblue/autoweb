...
*/
public class SiteObjectViewProc implements ViewProc{

    public String getName() {
        return "SiteObjectViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(SiteObjectViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(SiteObjectViewProc.class);
}
