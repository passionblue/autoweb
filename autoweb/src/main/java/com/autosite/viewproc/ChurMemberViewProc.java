...
public class ChurMemberViewProc implements ViewProc{

    public String getName() {
        return "ChurMemberViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ChurMemberViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ChurMemberViewProc.class);
}
