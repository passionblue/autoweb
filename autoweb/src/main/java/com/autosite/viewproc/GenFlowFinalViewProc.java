...
*/
public class GenFlowFinalViewProc implements ViewProc{

    public String getName() {
        return "GenFlowFinalViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(GenFlowFinalViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(GenFlowFinalViewProc.class);
}
