...
*/
public class CleanerRegisterStartViewProc implements ViewProc{

    public String getName() {
        return "CleanerRegisterStartViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerRegisterStartViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerRegisterStartViewProc.class);
}
