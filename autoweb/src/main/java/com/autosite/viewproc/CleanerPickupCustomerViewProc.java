...
public class CleanerPickupCustomerViewProc implements ViewProc{

    public String getName() {
        return "CleanerPickupCustomerViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerPickupCustomerViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerPickupCustomerViewProc.class);
}
