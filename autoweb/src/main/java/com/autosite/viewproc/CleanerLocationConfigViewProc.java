...
*/
public class CleanerLocationConfigViewProc implements ViewProc{

    public String getName() {
        return "CleanerLocationConfigViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerLocationConfigViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerLocationConfigViewProc.class);
}
