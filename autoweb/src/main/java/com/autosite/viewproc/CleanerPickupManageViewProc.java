...
public class CleanerPickupManageViewProc implements ViewProc{

    public String getName() {
        return "CleanerPickupManageViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerPickupManageViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerPickupManageViewProc.class);
}
