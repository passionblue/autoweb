...
public class ChurPayeeViewProc implements ViewProc{

    public String getName() {
        return "ChurPayeeViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ChurPayeeViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ChurPayeeViewProc.class);
}
