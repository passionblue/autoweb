...
public class ChurExpenseViewProc implements ViewProc{

    public String getName() {
        return "ChurExpenseViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ChurExpenseViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ChurExpenseViewProc.class);
}
