...
public class SiteHeaderViewProc implements ViewProc{

    public String getName() {
        return "SiteHeaderViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(SiteHeaderViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(SiteHeaderViewProc.class);
}
