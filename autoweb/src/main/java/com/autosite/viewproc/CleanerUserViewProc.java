...
*/
public class CleanerUserViewProc implements ViewProc{

    public String getName() {
        return "CleanerUserViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerUserViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerUserViewProc.class);
}
