...
*/
public class CleanerGarmentServiceViewProc implements ViewProc{

    public String getName() {
        return "CleanerGarmentServiceViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerGarmentServiceViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerGarmentServiceViewProc.class);
}
