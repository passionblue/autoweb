...
*/
public class CleanerCustomerNotificationViewProc implements ViewProc{

    public String getName() {
        return "CleanerCustomerNotificationViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerCustomerNotificationViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerCustomerNotificationViewProc.class);
}
