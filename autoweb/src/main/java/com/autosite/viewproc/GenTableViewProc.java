...
*/
public class GenTableViewProc implements ViewProc{

    public String getName() {
        return "GenTableViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(GenTableViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(GenTableViewProc.class);
}
