...
*/
public class SynkNodeTrackerViewProc implements ViewProc{

    public String getName() {
        return "SynkNodeTrackerViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(SynkNodeTrackerViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(SynkNodeTrackerViewProc.class);
}
