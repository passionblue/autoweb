...
public class ChurIncomeViewProc implements ViewProc{

    public String getName() {
        return "ChurIncomeViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ChurIncomeViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ChurIncomeViewProc.class);
}
