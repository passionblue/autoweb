...
*/
public class UserManageViewProc implements ViewProc{

    public String getName() {
        return "UserManageViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(UserManageViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(UserManageViewProc.class);
}
