...
*/
public class ExpenseItemViewProc implements ViewProc{

    public String getName() {
        return "ExpenseItemViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ExpenseItemViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ExpenseItemViewProc.class);
}
