...
*/
public class TestWrapViewProc implements ViewProc{

    public String getName() {
        return "TestWrapViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(TestWrapViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(TestWrapViewProc.class);
}
