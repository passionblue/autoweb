...
public class AutositeCommonViewProc implements ViewProc{

    public String getName() {
        return "AutositeCommonViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{

        m_logger.debug("################# " + AutositeCommonViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(AutositeCommonViewProc.class);
}
