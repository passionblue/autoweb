...
*/
public class CleanerServiceProcessViewProc implements ViewProc{

    public String getName() {
        return "CleanerServiceProcessViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerServiceProcessViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerServiceProcessViewProc.class);
}
