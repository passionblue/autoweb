...
*/
public class AutositeRemoteDeviceViewProc implements ViewProc{

    public String getName() {
        return "AutositeRemoteDeviceViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(AutositeRemoteDeviceViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(AutositeRemoteDeviceViewProc.class);
}
