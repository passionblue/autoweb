...
*/
public class CleanerCustomerViewProc implements ViewProc{

    public String getName() {
        return "CleanerCustomerViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerCustomerViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerCustomerViewProc.class);
}
