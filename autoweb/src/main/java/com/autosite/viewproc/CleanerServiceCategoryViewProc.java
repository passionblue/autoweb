...
*/
public class CleanerServiceCategoryViewProc implements ViewProc{

    public String getName() {
        return "CleanerServiceCategoryViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerServiceCategoryViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerServiceCategoryViewProc.class);
}
