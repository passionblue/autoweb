...
public class SiteConfigStyleViewProc implements ViewProc{

    public String getName() {
        return "SiteConfigStyleViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(SiteConfigStyleViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(SiteConfigStyleViewProc.class);
}
