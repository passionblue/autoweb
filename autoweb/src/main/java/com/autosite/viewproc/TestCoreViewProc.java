...
*/
public class TestCoreViewProc implements ViewProc{

    public String getName() {
        return "TestCoreViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(TestCoreViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(TestCoreViewProc.class);
}
