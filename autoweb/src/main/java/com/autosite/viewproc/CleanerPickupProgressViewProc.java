...
public class CleanerPickupProgressViewProc implements ViewProc{

    public String getName() {
        return "CleanerPickupProgressViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerPickupProgressViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerPickupProgressViewProc.class);
}
