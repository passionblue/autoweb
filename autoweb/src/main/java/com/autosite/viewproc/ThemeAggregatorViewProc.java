...
*/
public class ThemeAggregatorViewProc implements ViewProc{

    public String getName() {
        return "ThemeAggregatorViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ThemeAggregatorViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ThemeAggregatorViewProc.class);
}
