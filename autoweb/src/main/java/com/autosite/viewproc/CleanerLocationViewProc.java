...
*/
public class CleanerLocationViewProc implements ViewProc{

    public String getName() {
        return "CleanerLocationViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerLocationViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerLocationViewProc.class);
}
