...
public class ChurIncomeAddViewProc implements ViewProc{

    public String getName() {
        return "ChurIncomeAddViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ChurIncomeAddViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ChurIncomeAddViewProc.class);
}
