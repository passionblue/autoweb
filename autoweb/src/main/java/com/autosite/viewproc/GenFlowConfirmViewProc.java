...
*/
public class GenFlowConfirmViewProc implements ViewProc{

    public String getName() {
        return "GenFlowConfirmViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(GenFlowConfirmViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(GenFlowConfirmViewProc.class);
}
