...
*/
public class CleanerProductViewProc implements ViewProc{

    public String getName() {
        return "CleanerProductViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerProductViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerProductViewProc.class);
}
