...
*/
public class SynkNamespaceRecordViewProc implements ViewProc{

    public String getName() {
        return "SynkNamespaceRecordViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(SynkNamespaceRecordViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(SynkNamespaceRecordViewProc.class);
}
