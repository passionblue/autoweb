...
*/
public class CleanerGarmentTypeViewProc implements ViewProc{

    public String getName() {
        return "CleanerGarmentTypeViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerGarmentTypeViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerGarmentTypeViewProc.class);
}
