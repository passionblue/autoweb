...
*/
public class RegisterSimpleViewProc implements ViewProc{

    public String getName() {
        return "RegisterSimpleViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(RegisterSimpleViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(RegisterSimpleViewProc.class);
}
