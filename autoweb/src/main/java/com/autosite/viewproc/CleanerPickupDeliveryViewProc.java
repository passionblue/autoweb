...
*/
public class CleanerPickupDeliveryViewProc implements ViewProc{

    public String getName() {
        return "CleanerPickupDeliveryViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerPickupDeliveryViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerPickupDeliveryViewProc.class);
}
