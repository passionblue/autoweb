...
*/
public class GenMainViewProc implements ViewProc{

    public String getName() {
        return "GenMainViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(GenMainViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(GenMainViewProc.class);
}
