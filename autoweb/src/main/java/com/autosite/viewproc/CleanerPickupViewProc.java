...
public class CleanerPickupViewProc implements ViewProc{

    public String getName() {
        return "CleanerPickupViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(CleanerPickupViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(CleanerPickupViewProc.class);
}
