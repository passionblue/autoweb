...
*/
public class ResourceInclusionViewProc implements ViewProc{

    public String getName() {
        return "ResourceInclusionViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(ResourceInclusionViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(ResourceInclusionViewProc.class);
}
