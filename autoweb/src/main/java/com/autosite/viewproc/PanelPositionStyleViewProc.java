...
*/
public class PanelPositionStyleViewProc implements ViewProc{

    public String getName() {
        return "PanelPositionStyleViewProc";
    }

    
    public void process(HttpServletRequest request, HttpSession session, boolean nocache) throws Exception{
        m_logger.debug(PanelPositionStyleViewProc.class.getName());
    ...
    private static Logger m_logger = Logger.getLogger(PanelPositionStyleViewProc.class);
}
