...
public class DynamicMenuAction extends AutositeCoreAction {
    ...
    public ActionForward ex(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (dynPage == null ) {
            ...
            request.setAttribute("k_page_name", dynPageName);
        }
        ...
        if ( !isMissing(request.getParameter("cat"))) {
            ...
            request.setAttribute("k_page_category", category);
        } else {
            session.removeAttribute("k_page_category");
            request.removeAttribute("k_page_category");
        }
        ...
        // Setting underlying page. Underlying page is the static page name that displays the page contents. 
        // e.g. dynamic_content_page .... in view.properties
