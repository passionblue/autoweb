...
import com.autosite.holder.SiteHeaderDataHolder;


public class SiteHeaderAjaxAction extends SiteHeaderAction {

    public SiteHeaderAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (hasRequestValue(request, "ajaxOut", "getmodalstatus")){
            ...
            List fieldsTitle = SiteHeaderDataHolder.getFieldsName();
            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                SiteHeaderDataHolder _SiteHeader  = new SiteHeaderDataHolder( (SiteHeader) iterator.next());
                gen.addTableRow(_SiteHeader);
			}
    ...
    private static Logger m_logger = Logger.getLogger( SiteHeaderAjaxAction.class);
}
