...
import com.autosite.holder.ChurIncomeCategoryDataHolder;


public class ChurIncomeCategoryAjaxAction extends ChurIncomeCategoryAction {

    public ChurIncomeCategoryAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (hasRequestValue(request, "ajaxOut", "getmodalstatus")){
            ...
            List fieldsTitle = ChurIncomeCategoryDataHolder.getFieldsName();
            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                ChurIncomeCategoryDataHolder _ChurIncomeCategory  = new ChurIncomeCategoryDataHolder( (ChurIncomeCategory) iterator.next());
                gen.addTableRow(_ChurIncomeCategory);
			}
    ...
    private static Logger m_logger = Logger.getLogger( ChurIncomeCategoryAjaxAction.class);
}
