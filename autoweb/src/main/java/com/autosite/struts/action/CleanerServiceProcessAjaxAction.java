...
import com.autosite.holder.CleanerServiceProcessDataHolder;


public class CleanerServiceProcessAjaxAction extends CleanerServiceProcessAction {

    public CleanerServiceProcessAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = CleanerServiceProcessDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                CleanerServiceProcessDataHolder _CleanerServiceProcess  = new CleanerServiceProcessDataHolder( (CleanerServiceProcess) iterator.next());
                gen.addTableRow(_CleanerServiceProcess);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, CleanerServiceProcess target, boolean isList){
    ...
    private static Logger m_logger = Logger.getLogger( CleanerServiceProcessAjaxAction.class);
}
