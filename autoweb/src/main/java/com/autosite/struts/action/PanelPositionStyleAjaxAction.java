...
import com.autosite.holder.PanelPositionStyleDataHolder;


public class PanelPositionStyleAjaxAction extends PanelPositionStyleAction {

    public PanelPositionStyleAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = PanelPositionStyleDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                PanelPositionStyleDataHolder _PanelPositionStyle  = new PanelPositionStyleDataHolder( (PanelPositionStyle) iterator.next());
                gen.addTableRow(_PanelPositionStyle);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, PanelPositionStyle target, boolean isList){
    ...
    private static Logger m_logger = Logger.getLogger( PanelPositionStyleAjaxAction.class);
}
