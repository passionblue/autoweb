...
import com.autosite.holder.ChurExpenseCategoryDataHolder;


public class ChurExpenseCategoryAjaxAction extends ChurExpenseCategoryAction {

    public ChurExpenseCategoryAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (hasRequestValue(request, "ajaxOut", "getmodalstatus")){
            ...
            List fieldsTitle = ChurExpenseCategoryDataHolder.getFieldsName();
            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                ChurExpenseCategoryDataHolder _ChurExpenseCategory  = new ChurExpenseCategoryDataHolder( (ChurExpenseCategory) iterator.next());
                gen.addTableRow(_ChurExpenseCategory);
			}
    ...
    private static Logger m_logger = Logger.getLogger( ChurExpenseCategoryAjaxAction.class);
}
