...
public class GenFlowMidAjaxAction extends GenFlowMidAction {

    public GenFlowMidAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = GenFlowMidDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                GenFlowMidDataHolder _GenFlowMid = (GenFlowMidDataHolder) iterator.next();
                gen.addTableRow(_GenFlowMid);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, GenFlowMidDataHolder target, boolean isList){
    ...
    private static Logger m_logger = Logger.getLogger( GenFlowMidAjaxAction.class);
}
