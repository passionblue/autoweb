...
import com.autosite.holder.CleanerPickupDeliveryRecurDataHolder;


public class CleanerPickupDeliveryRecurAjaxAction extends CleanerPickupDeliveryRecurAction {

    public CleanerPickupDeliveryRecurAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = CleanerPickupDeliveryRecurDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                CleanerPickupDeliveryRecurDataHolder _CleanerPickupDeliveryRecur  = new CleanerPickupDeliveryRecurDataHolder( (CleanerPickupDeliveryRecur) iterator.next());
                gen.addTableRow(_CleanerPickupDeliveryRecur);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, CleanerPickupDeliveryRecur target, boolean isList){
    ...
    private static Logger m_logger = Logger.getLogger( CleanerPickupDeliveryRecurAjaxAction.class);
}
