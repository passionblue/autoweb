...
import com.autosite.holder.ResourceInclusionDataHolder;


public class ResourceInclusionAjaxAction extends ResourceInclusionAction {

    public ResourceInclusionAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = ResourceInclusionDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                ResourceInclusionDataHolder _ResourceInclusion  = new ResourceInclusionDataHolder( (ResourceInclusion) iterator.next());
                gen.addTableRow(_ResourceInclusion);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, ResourceInclusion target, boolean isList){
    ...
    private static Logger m_logger = Logger.getLogger( ResourceInclusionAjaxAction.class);
}
