...
public class GenFlowConfirmAjaxAction extends GenFlowConfirmAction {

    public GenFlowConfirmAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = GenFlowConfirmDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                GenFlowConfirmDataHolder _GenFlowConfirm = (GenFlowConfirmDataHolder) iterator.next();
                gen.addTableRow(_GenFlowConfirm);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, GenFlowConfirmDataHolder target, boolean isList){
    ...
    private static Logger m_logger = Logger.getLogger( GenFlowConfirmAjaxAction.class);
}
