...
import com.autosite.holder.SiteConfigStyleDataHolder;


public class SiteConfigStyleAjaxAction extends SiteConfigStyleAction {

    public SiteConfigStyleAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = SiteConfigStyleDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                SiteConfigStyleDataHolder _SiteConfigStyle  = new SiteConfigStyleDataHolder( (SiteConfigStyle) iterator.next());
                gen.addTableRow(_SiteConfigStyle);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, SiteConfigStyle target, boolean isList){
    ...
    protected boolean isActionCmd(HttpServletRequest request){
        return 
        hasRequestValue(request, "refreshTheme", "true")||
        super.isActionBasicCmd(request); 
    }

    private static Logger m_logger = Logger.getLogger( SiteConfigStyleAjaxAction.class);
}
