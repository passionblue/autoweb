...
import com.autosite.holder.ChurIncomeItemDataHolder;


public class ChurIncomeItemAjaxAction extends ChurIncomeItemAction {

    public ChurIncomeItemAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (hasRequestValue(request, "ajaxOut", "getmodalstatus")){
            ...
            List fieldsTitle = ChurIncomeItemDataHolder.getFieldsName();
            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                ChurIncomeItemDataHolder _ChurIncomeItem  = new ChurIncomeItemDataHolder( (ChurIncomeItem) iterator.next());
                gen.addTableRow(_ChurIncomeItem);
			}
    ...
    private static Logger m_logger = Logger.getLogger( ChurIncomeItemAjaxAction.class);
}
