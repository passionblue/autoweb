...
public class GenFlowFinalAjaxAction extends GenFlowFinalAction {

    public GenFlowFinalAjaxAction(){
    }
    ...
    public Map exAjax(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		// classes 
            ...
            List fieldsTitle = GenFlowFinalDataHolder.getFieldsName();

            gen.addTableRow(fieldsTitle, true);

            for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                GenFlowFinalDataHolder _GenFlowFinal = (GenFlowFinalDataHolder) iterator.next();
                gen.addTableRow(_GenFlowFinal);
			}
    ...
    protected List prepareReturnData(HttpServletRequest request, GenFlowFinalDataHolder target, boolean isList){
    ...
    private static Logger m_logger = Logger.getLogger( GenFlowFinalAjaxAction.class);
}
