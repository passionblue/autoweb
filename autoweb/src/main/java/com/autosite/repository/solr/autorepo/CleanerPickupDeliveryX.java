...
public class CleanerPickupDeliveryX extends com.autosite.db.BaseAutositeDataObject implements java.io.Serializable {
    ...
    /** default constructor */
    public CleanerPickupDeliveryX() {
    }

    /** minimal constructor */
    public CleanerPickupDeliveryX(long siteId, long locationId, long customerId, long ticketId, String pickupTicket, int isDeliveryRequest, int isWebRequest, int isRecurringRequest,
    ...
    /** full constructor */
    public CleanerPickupDeliveryX(long siteId, long locationId, long customerId, long ticketId, String ticketUid, String pickupTicket, String checkinTicketForDelivery, int isDeliveryRequest,
