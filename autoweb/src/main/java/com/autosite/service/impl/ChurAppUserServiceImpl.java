...
public class ChurAppUserServiceImpl extends AbstractUserServiceImpl{

    private static Logger m_logger = LoggerFactory.getLogger(ChurAppUserServiceImpl.class);
